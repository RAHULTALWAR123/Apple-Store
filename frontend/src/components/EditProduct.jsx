...
const categories = ["iPhone", "iPad", "MacBook", "Airpods", "Apple Watch", "iMac"];

const EditProduct = () => {
    
const {productId} = useParams();
    const {editProduct,loading,fetchProduct,product} = useProductStore();
...
>
    <h2 className='text-2xl font-semibold mb-6 text-indigo-600'>Edit Product</h2>
